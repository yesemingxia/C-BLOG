...
int Config::db_port() const { return get_int("db_port", 33060); }
...
std::string Config::jwt_secret() const { return get_string("jwt_secret", "cpp-blog-secret-key"); }
int Config::jwt_expire_seconds() const { return get_int("jwt_expire_seconds", 86400); }
